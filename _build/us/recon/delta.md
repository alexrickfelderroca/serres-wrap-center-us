...
| 4 | `pages/projects.html` | 418 | "Exclusivo" — 6 full builds/year programme |
| 5 | `pages/why-serres.html` | 504 | Standards (4) 347-386 · reviews 388-412 (stats 397-399, 5 testimonials 442-453) |
| 6 | `services/ppf.html` | 989 | hero · xform · protect (4 feats + 3-layer diagram) 529-583 · colour carousel 585-618 · FAQ ×6 620-694 · CTA |
...
| `/our-films` | **BRAND NEW page, partial source** | — | Harvestable: 3-layer TPU diagram `services/ppf.html:562-583`; brand lines `services/vinyl.html:689-691`; "50+ colours from several professional brands". The *argument* (3M vs NAR vs why-no-cheap-film, TPU vs TPH, yellowing under FL sun) is 100% new |
...
**4.5 `/dev/components` Storybook-style demo route (§5.3, P1-2).** Skip. It exists to keep a typed component library honest in a framework repo. There are no components to catalogue here — there are HTML sections. A dev route would be a second place to keep in sync and one more page to exclude from the sitemap.
