...
- `INV` ES→EN index built 1174-1181 (first ES value wins; **13 ES/CA collisions today** per `dict-tools check`: "Taller"→Studio/Workshop, "Camaleón"→Color Flip/Color Shift/Flip, "Valoración media", "Detalle trasero", "Parrilla iluminada", "Demana pressupost"). `enKeyOf()` 1184-1188 resolves either direction.
